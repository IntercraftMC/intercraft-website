...
<title>Application Received - InterCraft</title>
	...
	<tr>
		...
		<td class="header container">
				...
				<div class="content">
					<table bgcolor="#111">
					<tr>
						<td><img src="{{ secure_asset('images/brand_email.png') }}" /></td>
					</tr>
				</table>
				</div>
							...
							<tr>
								<td>
									...
									<table align="left" class="column">
										<tr>
											<td>				
												...
												<p class=""><a href="{{ config('social.facebook') }}" class="soc-btn fb">Facebook</a> <a href="{{ config('social.twitter') }}" class="soc-btn tw">Twitter</a></p>
									...
									<table align="left" class="column">
								        ...
								        <p>Email: <strong><a style="color: #24ACEB !important;" href="mailto:{{ config('mail.from.address') }}">{{ config('mail.from.address') }}</a></strong></p>
												<p>Website: <strong><a style="color: #24ACEB !important;" href="{{ route('home') }}">{{ config('app.name') }}</a></strong></p>
