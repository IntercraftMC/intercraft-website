...
<!-- HEADER -->
<table class="head-wrap" bgcolor="#111">
	<tr>
		<td></td>
			...
			<table>
				<tr>
					<td>
						...
						<p><img src="<?php echo $background; ?>" /></p><!-- /hero -->
						<br />
						<h3>Final Steps</h3>
						...
						<a class="btn" href="<?php echo $discord; ?>">Join Discord Server</a>
									...
									<table align="left" class="column">
										<tr>
											<td>				
												...
												<p class=""><a href="<?php echo $facebook; ?>" class="soc-btn fb">Facebook</a> <a href="<?php echo $twitter; ?>" class="soc-btn tw">Twitter</a></p>
									...
									<table align="left" class="column">
										<tr>
											<td>				
								                ...
								                <p>Email: <strong><a style="color: #24ACEB !important;" href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a></strong></p>
												<p>Website: <strong><a style="color: #24ACEB !important;" href="<?php echo $url; ?>"><?php echo $hostName; ?></a></strong></p>
